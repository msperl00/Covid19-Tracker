      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-x-4 ">
          ...
          <a href="https://www.linkedin.com/"
            class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 w-10 h-10 flex-shrink-0 cursor-pointer  rounded-full flex items-center justify-center">
            <img alt="instagram" src="https://cdn-icons-png.flaticon.com/512/1384/1384088.png" width="150"
              height="70" />
          </a>
          <a href="https://twitter.com/_MarcoItalian"
            class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 w-10 h-10 flex-shrink-0  cursor-pointer rounded-full flex items-center justify-center">
            <img alt="Twitter" src="https://cdn-icons-png.flaticon.com/512/733/733635.png" width="150" height="70" />
          </a>
          <a href="https://github.com/msperl00"
            class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400  w-10 h-10 flex-shrink-0 cursor-pointer  rounded-full flex items-center justify-center">
            <img alt="GitHub" src="https://cdn-icons-png.flaticon.com/512/25/25231.png" width="150" height="70" />
          </a>
        </div>
        <!-- grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4 -->
        <!-- <div class="mt-10 lg:block hidden">
          <label class="text-2xl font-medium leading-5 uppercase font-lora text-white ">Get updates</label>
          <div class="cursor-pointer flex items-center justify-between border border-gray-800 mt-4">
            ...
            <button aria-label="send"
              ...
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <a xlink:title="title (tooltip) text" link:href="http://google.com/"></a>
                <path
      ...
      <!-- <div class="mt-10 lg:hidden">
        ...
        <div class="flex items-center justify-between border border-gray-800 mt-4">
          ...
          <button aria-label="send"
            ...
            <svg class="fill-current text-gray-800 hover:text-gray-500" width="16" height="17" viewBox="0 0 16 17"
