<template>
    <div class=" relative flex flex-row h-12 mb-5 ">
    ...
    <div class="grid md:grid-cols-3 gap-3">
        <div class="shadow-md bg-blue-100 p-10 text-center rounded">
            <h3 class="text-2xl text-blue-900 font-bold   text-center font-lora uppercase mb-4 tracking-widest">Cases
            </h3>
            <div class="grid md:grid-cols-2">
                <div class="text-2xl ">
                    <ul class="text-left">
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">Count:</span>
                        </li>
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">PMP:</span>
                        </li>
                    </ul>
                </div>
        ...
        <div class="font-mono  flexstart">
            <img :src="getImage()" :alt="stats.country" class="w-auto h-36 my-10 shadow-2xl shadow-slate-600 ">
        </div>
        <div class="shadow-md bg-blue-100 p-10 text-center rounded">
            <h3 class="text-xl text-blue-900 font-bold   text-center font-lora uppercase mb-8 tracking-widest">Active
                cases</h3>
            <div class="grid md:grid-cols-2">
                <div class="text-2xl ">
                    <ul class="text-left">
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">Active:</span>
                        </li>
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">PMP:</span>
                        ...
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">OCPP:</span>
                        </li>
                    </ul>
                </div>
                <div class="grid text-2xl">
        ...
        <!-- ! FILA 2 -->
        <div class="shadow-md bg-blue-100 p-10 text-center rounded">
            <h3 class="text-2xl text-blue-900 font-bold   text-center font-lora uppercase mb-8 tracking-widest">Deaths
            </h3>
            <div class="grid md:grid-cols-2">
                <div class="text-2xl ">
                    <ul class="text-left">
                        ...
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">ODPP:</span>
                        </li>
                    </ul>
                </div>
                <div class="grid text-2xl">
        ...
        <div class="shadow-md bg-blue-100 p-10 text-center rounded">
            <h3 class="text-xl text-blue-900 font-bold   text-center font-lora uppercase mb-8 tracking-widest">Critical cases</h3>
            <div class="grid md:grid-cols-2">
                <div class="text-2xl ">
                    <ul class="text-left">
                        <li>
        ...
        <div class="shadow-md bg-blue-100 p-10 text-center rounded">
            <h3 class="text-2xl text-blue-900 font-bold   text-center font-lora uppercase mb-8 tracking-widest">Tests
            </h3>
            <div class="grid md:grid-cols-2">
                <div class="text-2xl ">
                    <ul class="text-left">
        ...
        <div class="shadow-md bg-blue-100 p-10 text-center rounded">
            <h3 class="text-xl text-blue-900 font-bold   text-center font-lora uppercase mb-8 tracking-widest">Recovered
                cases</h3>
            <div class="grid md:grid-cols-2">
                <div class="text-2xl ">
                    <ul class="text-left">
                        ...
                        <li>
                            <span
                                class="font-medium text-blue-900 opacity-90 hover:text-red-600 mr-2 text-left">Today:</span>
                        </li>
                    </ul>
                </div>
                <div class="grid text-2xl">
    ...
    setup(props, context) {
        ...
        function getImage() {
            ...
            if (props.stats.countryInfo == undefined) {
                url.value = 'public/images/Coronavirus/earth.png';
                return 'public/images/Coronavirus/earth.png';
            }
